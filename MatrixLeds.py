...
class MatrixLeds():
  ...
  def process_frame(self):
    ...
    if self.effect.is_rgb:
      ...
      # foreground color
      effect_frame[:,:,0][effect_frame[:,:,0] > 0] *= self.fg_color[1]
      effect_frame[:,:,1][effect_frame[:,:,1] > 0] *= self.fg_color[0]
      effect_frame[:,:,2][effect_frame[:,:,2] > 0] *= self.fg_color[2]

      # background color
      effect_frame[:,:,0][effect_frame[:,:,0] < 0] *= -self.bg_color[1]
      effect_frame[:,:,1][effect_frame[:,:,1] < 0] *= -self.bg_color[0]
      effect_frame[:,:,2][effect_frame[:,:,2] < 0] *= -self.bg_color[2]
